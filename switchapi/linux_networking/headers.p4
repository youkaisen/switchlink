...
/* TODO: This is the Ethernet protocol assigned for PBB (Provider
 * Backbone Bridging).  The intended value for the constant
 * ETHERTYPE_MAC might be different than this. */
